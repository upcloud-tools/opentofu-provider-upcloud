...
- upcloud_server: fix panic when removing only backup rule in the server
...
- upcloud_firewall_rules: require replacement when `server_id` value changes
...
[5.36.3]: https://github.com/UpCloudLtd/terraform-provider-upcloud/compare/v5.36.2...v5.36.3
[5.36.2]: https://github.com/UpCloudLtd/terraform-provider-upcloud/compare/v5.36.1...v5.36.2
[5.36.1]: https://github.com/UpCloudLtd/terraform-provider-upcloud/compare/v5.36.0...v5.36.1
[5.36.0]: https://github.com/UpCloudLtd/terraform-provider-upcloud/compare/v5.35.0...v5.36.0
...
[5.23.3]: https://github.com/UpCloudLtd/terraform-provider-upcloud/compare/v5.23.2...v5.23.3
